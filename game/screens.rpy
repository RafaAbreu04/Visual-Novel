...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Salv. Rápido") action QuickSave()
            textbutton _("Carga Rápida") action QuickLoad()
            textbutton _("Controles") action ShowMenu('preferences')
...
screen about():
    ...
    use game_menu(_("Créditos"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Game Programming: Rafaelly Abreu\n \nGame Design: Nicolas Litsas and Rafaelly Abreu\n \nGame Production: Nicolas Litsas\n \nArt: Nicolas Litsas and Rafaelly Abreu\n \nAudio: Nicolas Litsas and Rafaelly Abreu\n \nQuality Assurance: Nicolas Litsas\n \nMade with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Depois das escolhas") action Preference("after choices", "toggle")
...
screen keyboard_help():
    ...
    hbox:
        label _("Setas")
        text _("Navegar pela interface.")

    hbox:
        label _("Esc")
        text _("Acesso ao menu do jogo.")

    hbox:
        label _("Ctrl")
        text _("Pula o diálogo enquanto pressionado.")

    hbox:
        label _("Tab")
        text _("Alterna para o modo pular.")

    hbox:
        label _("Page Up")
        text _("Volta para o texto anterior.")

    hbox:
        label _("Page Down")
        text _("Avança para o próximo texto.")

    hbox:
        label "H"
        text _("Esconde a interface do utilizador.")
    ...
    hbox:
        label "V"
        text _("Alterna para {a=https://www.renpy.org/l/voicing}assistência de voz{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Scroll do mouse para cima")
        text _("Volta para o texto anterior.")

    hbox:
        label _("Scroll do mouse para baixo")
        text _("Avança para o próximo texto.")
